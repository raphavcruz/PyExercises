...
def gen_report():
    ...
    doc.render({"DATE_INPUT": Cal_Entry2,
    ...
    filedialog.asksaveasfile(defaultextension=".docx", title= "Save wash report as: ", mode= "w", initialfile= file_name)
...
button.grid(row=15, columnspan=2, sticky="news")
